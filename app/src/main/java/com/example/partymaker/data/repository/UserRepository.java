...
public class UserRepository {
    ...
    private final MutableLiveData<Map<String, User>> allUsers = new MutableLiveData<>(new HashMap<>());
     ...
     * @param forceRefresh Whether to force a refresh from the server
     */
    public void getCurrentUser(android.content.Context context, DataCallback<User> callback, boolean forceRefresh) {
        try {
            ...
            // Fetch from server
            getUser(userKey, new DataCallback<User>() {
                @Override

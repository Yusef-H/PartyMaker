...
public class User {
  ...
  /**
   * Constructs a user with username and email. Generates a random UUID for the userKey.
   *
   * @param username The user's display name
   * @param email The user's email address
   */
  ...
  /**
   * Gets the user's display name (alternative field name). This is for backward compatibility with
   * existing data.
   *
   * @return The username
   */
  ...
  /**
   * Sets the user's display name (alternative field name). This is for backward compatibility with
   * existing data.
   *
   * @param userName The username
   */

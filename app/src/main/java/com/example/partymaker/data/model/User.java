 ...
 * Contains user information and provides methods for accessing and modifying that information.
 */
public class User implements Serializable {
    ...
    public boolean hasFriend(String friendKey) {
        return friendKey != null && !friendKey.isEmpty() && friendKeys != null && friendKeys.containsKey(friendKey);
    }
    ...
    public boolean isInGroup(String groupKey) {
        return groupKey != null && !groupKey.isEmpty() && groupKeys != null && groupKeys.containsKey(groupKey);
    }

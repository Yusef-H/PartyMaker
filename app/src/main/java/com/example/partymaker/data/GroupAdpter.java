...
public class GroupAdpter extends ArrayAdapter<Group> {
    ...
    public GroupAdpter(@NonNull Context context, @LayoutRes int resource, @IdRes int textViewResourceId, @NonNull List<Group> GroupList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String GroupDate = (temp.getGroupDays() + " " + temp.getGroupMonths() + " " + temp.getGroupYears());

 ...
 * Provides methods to query, insert, and update groups in the local database.
 */
@Dao
public interface GroupDao {
     ...
     * This is a simplified version that just returns all groups for now
     * In a real implementation, this would filter groups by user
     *

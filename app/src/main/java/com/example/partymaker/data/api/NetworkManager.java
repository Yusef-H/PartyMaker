...
/**
 * Manager for network operations and connectivity monitoring.
 * Provides utilities for checking network status, monitoring changes, and handling timeouts.
 */
public class NetworkManager {
    ...
    private void updateNetworkStatus(final boolean isAvailable) {
        mainHandler.post(() -> {
            if (isNetworkAvailable.getValue() == null || isNetworkAvailable.getValue() != isAvailable) {
    ...
    /**
     * Releases resources used by the NetworkManager.

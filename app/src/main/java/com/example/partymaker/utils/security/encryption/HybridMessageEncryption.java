 ...
 *
 * <p>Architecture: 1. Each user has RSA key pair (2048-bit) 2. Each message encrypted with unique
 * AES key (256-bit) 3. AES key encrypted with recipient's RSA public key 4. Supports group
  ...
  public String getEncryptionStatus() {
    try {
      ...
      return String.format(
          Locale.US,
          "User: %s, RSA KeyPair: %s, Algorithm: RSA-%d + AES-%d",
          currentUserId,
          hasKeyPair ? "✓" : "✗",
          RSA_KEY_SIZE,
          AES_KEY_SIZE);

 ...
 * Provides a clean API for background operations with UI thread callbacks.
 */
public class AsyncTaskReplacement {
     ...
     */
    public static abstract class SimpleUICallback<T> implements UICallback<T> {
        @Override
    ...
    public static <T> Future<?> execute(
            @NonNull BackgroundTask<T> backgroundTask,
            @NonNull UICallback<T> uiCallback) {
    ...
    public static <T> Future<?> execute(
            @NonNull BackgroundTask<T> backgroundTask,
            @NonNull ResultCallback<T> resultCallback) {
        
        return execute(backgroundTask, new SimpleUICallback<T>() {
            @Override
    ...
    public static class NetworkTask {
        ...
        public static Future<?> executeRequest(
                @NonNull HttpRequestTask requestTask,
    ...
    public static class DatabaseTask {
        ...
        public static <T> Future<?> executeDbOperation(
                @NonNull DatabaseOperation<T> dbOperation,
                @NonNull DatabaseCallback<T> dbCallback) {

...
/**
 * Enhanced encrypted SharedPreferences manager using AndroidX Security library.
...
public class EncryptedSharedPreferencesManager {
    ...
    public static synchronized EncryptedSharedPreferencesManager getInstance(@NonNull Context context) {
        if (instance == null) {
    ...
    public void migrateFromRegularPreferences(@NonNull String regularPrefsName) {
        ...
        try {
            SharedPreferences regularPrefs = context.getSharedPreferences(regularPrefsName, Context.MODE_PRIVATE);
            Editor editor = edit();

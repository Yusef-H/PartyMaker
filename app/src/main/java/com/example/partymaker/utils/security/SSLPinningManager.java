...
/**
 * Enhanced SSL Certificate Pinning Manager for secure network connections.
...
public class SSLPinningManager {
    ...
    private static final String[] RENDER_PINS = {
        ...
        "sha256/mEflZT5enoR1FuXLgYYGqnVEoZvmf9c2bVBpiOjYQ0c=", // CN=GTS Root R4,O=Google Trust Services LLC,C=US
    };
    ...
    public OkHttpClient createSecureClient() {
        ...
        if (isProduction) {
            ...
            CertificatePinner certificatePinner = new CertificatePinner.Builder()
                .add("partymaker.onrender.com", RENDER_PINS)
                .build();
    ...
    public boolean validateCertificate(X509Certificate certificate) {
        try {
            ...
            if (!isValid) {
                ...
                SecurityEvent.logSecurityViolation("SSL_PINNING_FAILURE", 
                    "Certificate pin mismatch: " + certificate.getSubjectDN());
            }
    ...
    private class CustomHostnameVerifier implements HostnameVerifier {
        ...
        public boolean verify(String hostname, SSLSession session) {
            ...
            if (!isAllowed) {
                ...
                SecurityEvent.logSecurityViolation("HOSTNAME_VERIFICATION_FAILURE", 
                    "Unexpected hostname: " + hostname);
            }

...
/**
 * Custom refresh animation helper for PartyMaker Creates party-themed pull-to-refresh animations
 */
public class CustomRefreshAnimationHelper {
  ...
  public static void createCustomRefreshAnimation(
      @NonNull View parentView, @NonNull LottieAnimationView refreshLottie, boolean isRefreshing) {
    if (isRefreshing) {
  ...
  public static void stopRefreshBounceAnimation(@NonNull View view) {
    ValueAnimator animator =
        (ValueAnimator) view.getTag(com.example.partymaker.R.id.refresh_animator_tag);
    if (animator != null) {
      animator.cancel();

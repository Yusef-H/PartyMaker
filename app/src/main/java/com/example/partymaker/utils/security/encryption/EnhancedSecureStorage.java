...
/**
 * Enhanced secure storage with AES-GCM encryption and random IV per message.
 * Fixes critical security vulnerabilities in SimpleSecureStorage:
 * - Random IV per encryption operation
 * - Authenticated encryption (GCM mode)
 * - Per-user encryption keys
 * - Proper key storage with Android security
 */
public class EnhancedSecureStorage {
    ...
    /**
     * Encrypt string with random IV per operation
     ...
     * Uses proper key generation instead of password-based derivation
     */
    ...
    /**
     * Key rotation - generate new key for user
     * Call this periodically for enhanced security
     */
    ...
    public String getEncryptionInfo() {
        return String.format("Algorithm: %s, User: %s, IV Length: %d, Tag Length: %d", 
            ALGORITHM, userId, GCM_IV_LENGTH, GCM_TAG_LENGTH);
    }
}
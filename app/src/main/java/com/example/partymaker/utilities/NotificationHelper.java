...
/**
 * Helper class for handling notifications in the app.
 * This class provides methods for creating notification channels
...
public class NotificationHelper {
     ...
     */
    public static void showPartyNotification(Context context, String title, String message, Group group) {
     ...
     */
    public static void showMessageNotification(Context context, String title, String message, String groupId) {
        // Only show notification if subscribed to this group
    ...
    private static void showNotification(Context context, String title, String message, 
                                        Intent intent, String channelId, int notificationId) {

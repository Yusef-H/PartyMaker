...
public class MapUtilities {
    ...
    /**
     * Requests ACCESS_FINE_LOCATION from the user if not already granted.
     * If the permission is already granted, calls enableMyLocation(...) immediately.
     */
    ...
    /**
     * If (and only if) the ACCESS_FINE_LOCATION permission is granted, turn on “My Location”
     * layer on the given GoogleMap, and then move the camera to the user’s last known location.
     *
    ...
    public static void enableMyLocation(
        ...
        // Double-check that ACCESS_FINE_LOCATION is actually granted before calling setMyLocationEnabled
        if (ActivityCompat.checkSelfPermission(
            ...
            locationClient.getLastLocation()
                    ...
                    .addOnFailureListener(e -> {
                        ...
                        Toast.makeText(context, "Could not fetch last location.", Toast.LENGTH_SHORT).show();
                    });
        }
    }

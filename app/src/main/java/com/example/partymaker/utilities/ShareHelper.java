...
/**
 * Helper class for sharing party information with other apps.
 * This class provides methods for sharing party details via text, 
 * generating shareable images, and sharing to specific platforms.
 */
public class ShareHelper {
    ...
    public static void shareToWhatsApp(Context context, Group group) {
        try {
            ...
            Toast.makeText(context, "WhatsApp is not installed or an error occurred", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public static void shareToFacebook(Context context, Group group) {
        try {
            ...
            Toast.makeText(context, "Facebook is not installed or an error occurred", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private static String createShareMessage(Group group) {
        ...
        // Date and time
        message.append("📅 Date: ")
                .append(group.getGroupDays()).append("/")
                .append(group.getGroupMonths()).append("/")
                .append(group.getGroupYears()).append("\n");

...
/**
 * Application class for PartyMaker.
 * Initializes repositories and other app-wide components.
 */
public class PartyApplication extends Application {
    ...
    /**
     * Initializes all repositories with application context.
     * This enables caching and offline support.
     */

 ...
 * Provides methods for checking memory usage and clearing caches.
 */
public class MemoryManager {
    ...
    public static boolean isLowMemory(Context context) {
        ...
        // Log memory info
        Log.d(TAG, String.format("Memory - Available: %.2f MB, Total: %.2f MB, %.1f%% free",
    ...
    public static String getDetailedMemoryInfo() {
        ...
        sb.append("- Used: ").append(FileManager.formatSize(usedMemory)).append(" (")
                .append(String.format("%.1f%%", 100.0f * usedMemory / maxMemory)).append(")\n");
        sb.append("- Free: ").append(FileManager.formatSize(freeMemory)).append("\n");
        
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            sb.append("- PSS Total: ").append(FileManager.formatSize(memoryInfo.getTotalPss() * 1024L)).append("\n");
            sb.append("- Private Dirty: ").append(FileManager.formatSize(memoryInfo.getTotalPrivateDirty() * 1024L)).append("\n");
            sb.append("- Shared Dirty: ").append(FileManager.formatSize(memoryInfo.getTotalSharedDirty() * 1024L)).append("\n");
        }

 ...
 * This improves performance by reducing memory usage and network transfer size.
 */
public class ImageCompressor {
     ...
     */
    private static Bitmap loadScaledBitmapFromUri(Context context, Uri imageUri, int maxWidth, int maxHeight) {
        try {

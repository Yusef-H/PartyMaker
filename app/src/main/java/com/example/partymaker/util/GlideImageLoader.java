...
/**
 * Utility class for loading images efficiently using Glide.
 * Provides centralized image loading with consistent caching and error handling.
 */
public class GlideImageLoader {
     ...
     */
    public static void loadImage(Context context, String imageUrl, ImageView imageView, @DrawableRes int placeholderResId) {
    ...
    public static void loadProfileImage(Context context, String imageUrl, ImageView imageView) {
        ...
        Glide.with(context)
                .load(imageUrl)
                .apply(getDefaultRequestOptions(R.drawable.default_profile_image)
                        .circleCrop())
                .into(imageView);
    }

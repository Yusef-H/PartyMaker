 ...
 * Provides methods for creating, saving, and sharing files.
 */
public class FileManager {
     ...
     * @param callback Callback for the operation
     */
    public static void copyFile(Context context, Uri sourceUri, File destFile, FileOperationCallback callback) {
        executor.execute(() -> {
            try {
    ...
    private static void deleteRecursive(File fileOrDirectory) {
        ...
        if (!fileOrDirectory.getAbsolutePath().equals(fileOrDirectory.getParentFile().getAbsolutePath())) {

...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(Html.fromHtml("<font color='#FFFFFF'><b>My Parties</b></font>", Html.FROM_HTML_MODE_LEGACY));
    ...
    private void setupEventHandlers() {
        lv1.setOnItemClickListener((parent, view, position, id) -> navigateToGroupScreen(groupList.get(position)));
    }

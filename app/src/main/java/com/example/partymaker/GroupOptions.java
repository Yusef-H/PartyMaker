    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBref.refStorage
                ...
                .addOnSuccessListener(
                        uri -> Picasso.get().load(uri).into(imgEditGroup))
            ...
            if (requestCode == 100) {
                ...
                if (null != uri) {
                    ...
                    DBref.refStorage
                            ...
                            .putFile(uri)
                            .addOnSuccessListener(
                                    taskSnapshot -> Toast.makeText(GroupOptions.this, "saved", Toast.LENGTH_SHORT).show())
                            .addOnFailureListener(
                                    exception -> Toast.makeText(GroupOptions.this, "error while saving ", Toast.LENGTH_SHORT)
                                            .show());
                }
            }
        }
            ...
            cardView.setOnClickListener(
                    view -> {
                        ...
                        } else if (finalI == 2) // open 2,1 (3) Delete Group
                        {
                            ...
                            Toast.makeText(GroupOptions.this, "successfully deleted", Toast.LENGTH_SHORT)
                                    .show();

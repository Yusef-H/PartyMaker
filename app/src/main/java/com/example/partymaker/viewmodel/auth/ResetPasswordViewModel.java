 ...
 * 
 * <p>Handles password reset operations including email validation,
 * sending reset emails, and providing user feedback.
 * 
 * <p>Features:
 * <ul>
 *   <li>Email validation for reset requests</li>
 *   <li>Password reset email sending</li>
 *   <li>Reset request tracking</li>
    ...
    public void sendPasswordResetEmail(@NonNull String email) {
        ...
        executeIfNotLoading(() -> {
            ...
            if (!canSendResetEmail()) {
                long timeRemaining = (lastResetRequestTime + RESET_COOLDOWN_MS) - System.currentTimeMillis();
                setError("Please wait " + (timeRemaining / 1000) + " seconds before requesting another reset", 
            ...
            firebaseAuth.sendPasswordResetEmail(email.trim().toLowerCase())

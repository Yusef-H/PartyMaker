 ...
 * 
 * <p>Handles the main group view operations including group details display,
 * member management, admin actions, and user interactions within a group.
 * 
 * <p>Features:
 * <ul>
 *   <li>Group information display and updates</li>
 *   <li>Member list management and display</li>
 *   <li>Join/leave group operations</li>
 *   <li>Admin privilege checking and actions</li>
 *   <li>Real-time group updates</li>
 *   <li>User status tracking within group</li>
 * </ul>
 * 
...
public class PartyMainViewModel extends BaseViewModel {
    ...
    public void loadCurrentUser() {
        ...
        ThreadUtils.runOnBackground(() -> {
            userRepository.getUser(currentUserKey, new UserRepository.Callback<User>() {
                @Override
    ...
    public void joinGroup() {
        ...
        ThreadUtils.runOnBackground(() -> {
            groupRepository.joinGroup(currentGroupKey, currentUserKey, 
    ...
    public void leaveGroup() {
        ...
        ThreadUtils.runOnBackground(() -> {
            groupRepository.leaveGroup(currentGroupKey, currentUserKey, 
                new GroupRepository.Callback<Boolean>() {
                    @Override
                    public void onSuccess(Boolean result) {
                        handleLeaveSuccess();
    ...
    public void updateAttendanceStatus(boolean isComing) {
        ...
        if (!isCurrentUserMember()) {
            setError("You must be a member to update attendance", NetworkUtils.ErrorType.PERMISSION_ERROR);
            return;
        }
        ...
        ThreadUtils.runOnBackground(() -> {
            groupRepository.updateAttendanceStatus(currentGroupKey, currentUserKey, isComing, 
                new GroupRepository.Callback<Boolean>() {
                    @Override
                    public void onSuccess(Boolean result) {
    ...
    private void loadUsersFromKeys(@Nullable HashMap<String, Object> userKeys, 
    ...
    private void updateStatistics(Group group) {
        ...
        Log.d(TAG, "Statistics updated - Total: " + totalMembers + 
    ...
    private void handleAttendanceUpdateSuccess(boolean isComing) {
        ...
        ThreadUtils.runOnMainThread(() -> {
            ...
            String message = isComing ? "You're now attending this event!" : 

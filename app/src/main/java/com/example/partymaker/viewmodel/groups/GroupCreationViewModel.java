 ...
 * 
 * <p>Handles group creation process including validation, image upload,
 * location selection, and comprehensive group setup.
 * 
 * <p>Features:
 * <ul>
 *   <li>Group information validation</li>
 ...
 *   <li>Member capacity management</li>
 * </ul>
 * 
...
public class GroupCreationViewModel extends BaseViewModel {
        ...
        executeIfNotLoading(() -> {
            ...
            ThreadUtils.runOnBackground(() -> {
                try {
                    ...
                    groupRepository.createGroup(newGroup, new GroupRepository.Callback<Group>() {
                        @Override
    ...
    private void updateFormValidation() {
        ThreadUtils.runOnMainThread(() -> {
            ...
            boolean formValid = (nameValid != null && nameValid) &&
    ...
    private void handleGroupCreationError(Exception error) {
        ...
        ThreadUtils.runOnMainThread(() -> {
            ...
            setError("Failed to create group: " + (errorMessage != null ? errorMessage : "Unknown error"), errorType);
        });
    }

 ...
 *
 * <p>Handles public group browsing, searching, filtering, and joining operations with comprehensive
 * state management and user feedback.
 *
 * <p>Features:
 *
 * <ul>
 *   <li>Public group browsing and listing
 *   <li>Group search and filtering
 *   <li>Join/leave group operations
 *   <li>Group details preview
...
public class GroupDiscoveryViewModel extends BaseViewModel {
  ...
  public boolean isUserMemberOfGroup(@NonNull Group group) {
    ...
    return group.getFriendKeys() != null && group.getFriendKeys().containsKey(currentUserKey);
  }
        ...
        () -> {
          try {
            ...
            if (joinableOnly != null && joinableOnly) {
              filtered =
                  filtered.stream().filter(this::canUserJoinGroup).collect(Collectors.toList());
            }
            ...
            ThreadUtils.runOnMainThread(
                () -> {
                  ...
                  Log.d(
                      ...
                      "Filters applied - "
                          + finalFiltered.size()
                          + " groups match criteria out of "
                          + allPublicGroups.size()
                          + " total");
                });

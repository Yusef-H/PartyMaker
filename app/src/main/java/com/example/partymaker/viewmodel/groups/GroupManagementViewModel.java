 ...
 * 
 * <p>Handles administrative operations for group management including
 * member management, group settings, admin actions, and group lifecycle.
 * 
 * <p>Features:
 * <ul>
 *   <li>Member management (add, remove, promote, demote)</li>
 *   <li>Group settings and configuration</li>
 *   <li>Admin role management</li>
 *   <li>Group deletion and archiving</li>
 *   <li>Invitation management</li>
 *   <li>Group statistics and analytics</li>
 * </ul>
 * 
...
public class GroupManagementViewModel extends BaseViewModel {
    ...
    public void loadGroupMembers() {
        ...
        ThreadUtils.runOnBackground(() -> {
            ...
            for (String memberKey : memberKeys.keySet()) {
                userRepository.getUser(memberKey, new UserRepository.Callback<User>() {
                    @Override
    ...
    public void addMember(@NonNull User user) {
        ...
        ThreadUtils.runOnBackground(() -> {
            groupRepository.addMemberToGroup(currentGroupKey, user.getUserKey(), 
    ...
    public void removeMember(@NonNull User user) {
        ...
        ThreadUtils.runOnBackground(() -> {
            groupRepository.removeMemberFromGroup(currentGroupKey, user.getUserKey(), 
                new GroupRepository.Callback<Boolean>() {
                    @Override
                    public void onSuccess(Boolean result) {
    ...
    public void deleteGroup() {
        ...
        ThreadUtils.runOnBackground(() -> {
            groupRepository.deleteGroup(currentGroupKey, new GroupRepository.Callback<Boolean>() {
                @Override
                public void onSuccess(Boolean result) {

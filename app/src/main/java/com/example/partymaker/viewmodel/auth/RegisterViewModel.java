 ...
 *   <li>Registration progress tracking</li>
 * </ul>
 * 
...
public class RegisterViewModel extends BaseViewModel {
    ...
    public void validateUsername(@NonNull String username) {
        ThreadUtils.runOnBackground(() -> {
            try {
                ...
                if (!valid) {
                    validationError.postValue("Username must be 3-20 characters long and contain only letters, numbers, and underscores");
                } else {
                    validationError.postValue(null);
                }
    ...
    public void registerUser(@NonNull String email, @NonNull String password, 
                           @NonNull String username, String fullName) {
                        ...
                        .addOnCompleteListener(task -> {
                            if (task.isSuccessful()) {
                                ...
                                if (firebaseUser != null) {
                                    ...
                                    handleRegistrationError("Registration failed: User creation unsuccessful");
                                }
                            } else {
    ...
    private void handleRegistrationSuccess(FirebaseUser firebaseUser, String username, String fullName) {

...
public class UserViewModel extends ViewModel {
    ...
    public UserViewModel() {
        ...
        ConnectivityManager.getInstance().getNetworkAvailability().observeForever(isAvailable -> {
    ...
    public void loadAllUsers(boolean forceRefresh) {
        ...
        repository.getAllUsers(new UserRepository.DataCallback<List<User>>() {
            @Override
    ...
    public void loadUser(String userId, boolean forceRefresh) {
        ...
        repository.getUser(userId, new UserRepository.DataCallback<User>() {
            @Override
    ...
    public void updateCurrentUser(Map<String, Object> updates) {
        ...
        repository.updateUser(userId, updates, new UserRepository.OperationCallback() {
            @Override
    ...
    public void createUser(String userId, User user) {
        ...
        repository.saveUser(userId, user, new UserRepository.OperationCallback() {
            @Override
            public void onComplete() {
    ...
    private NetworkUtils.ErrorType determineErrorType(String errorMessage) {
        ...
        if (lowerCaseError.contains("network") || lowerCaseError.contains("internet") || 
        ...
        } else if (lowerCaseError.contains("authentication") || lowerCaseError.contains("auth") || 
                  lowerCaseError.contains("permission") || lowerCaseError.contains("access")) {

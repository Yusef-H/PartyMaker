...
/**
 * ViewModel for managing Group data operations in MainActivity. Provides a clean API for the UI to
 * interact with Group data, including loading, creating, updating, and deleting groups.
 */

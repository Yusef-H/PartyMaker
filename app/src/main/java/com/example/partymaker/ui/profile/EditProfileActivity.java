...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private final ActivityResultLauncher<String> imagePickerLauncher =
            registerForActivityResult(new ActivityResultContracts.GetContent(), this::uploadImageToFirebase);
    ...
    private String createStyledTitle() {
        return String.format(
                "<font color='%s'><b>%s</b></font>", EditProfileActivity.ACTION_BAR_TITLE_COLOR, "Edit Profile");
    }
    ...
    private void loadProfileImage() {
        ...
        DBRef.refStorage.child("Users/" + safeEmail)
                .getDownloadUrl()

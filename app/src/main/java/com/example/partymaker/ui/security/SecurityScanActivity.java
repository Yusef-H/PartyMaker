package com.example.partymaker.ui.security;
...
import com.example.partymaker.utils.security.SecurityAgent;
import com.example.partymaker.utils.security.SecurityReport;
...
public class SecurityScanActivity extends AppCompatActivity {
    ...
    private void runSecurityScan() {
        ...
        securityAgent.performSecurityScan()
    ...
    private void displayResults(SecurityReport report) {
        ...
        if (totalIssues == 0) {
            ...
            tvIssuesFound.setText(String.format(Locale.getDefault(), "%d security issues found", totalIssues));
    ...
    private void exportReport() {
        ...
        try {
            ...
            Toast.makeText(this, "Reports exported to:\n" + reportsDir.getPath(), Toast.LENGTH_LONG).show();
    ...
    private void shareReport() {
        ...
        try {
            ...
            shareIntent.putExtra(Intent.EXTRA_TEXT, 
                "Security Score: " + currentReport.getOverallScore() + "/100\n" +
                "Grade: " + currentReport.getSecurityGrade());

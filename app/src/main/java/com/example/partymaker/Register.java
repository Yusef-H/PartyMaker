...
public class Register extends AppCompatActivity {
    ...
    private void updatePasswordStrength(String password) {
        ...
        ValueAnimator progressAnimator = ValueAnimator.ofInt(passwordStrengthBar.getProgress(), strength);
        progressAnimator.setDuration(300);
        progressAnimator.addUpdateListener(animation ->
                passwordStrengthBar.setProgress((Integer) animation.getAnimatedValue()));
    ...
    private void animateFormProgress() {
        ...
        int color = completedFields == 3 ? Color.GREEN :
                completedFields >= 2 ? Color.BLUE :
                        completedFields == 1 ? Color.RED : Color.GRAY;
...
// Password validation with animation
    ...
    private void setErrorWithAnimation(TextInputLayout layout, String error) {
        ...
        ObjectAnimator shake = ObjectAnimator.ofFloat(layout, "translationX", 0, 25, -25, 25, -25, 15, -15, 6, -6, 0);
    ...
    private void createConfettiEffect() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            confetti.setBackgroundColor(Color.HSVToColor(new float[]{(float) (Math.random() * 360), 1f, 1f}));
            ...
            confettiSet.addListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationEnd(Animator animation) {
